let students = [
    ...
    {userName:'Grace', firstName:'Grace', lastName: 'Birdwell', day:'Wed', time:'8:00am', grade:'7th', level:'2', arrayOfAssignments: [{title:"Grace's assignment", description:"Grace's assignments", notes: "Grace's notes", date: "10/3/2022"}], personalInfo: {phone:'435-259-0000', email:'gggg@gggg.com', parentNames:'Chelsea and Drew Birdwell', address:'111 N Road Drive', startDate:'1/6/2020'}}, 
